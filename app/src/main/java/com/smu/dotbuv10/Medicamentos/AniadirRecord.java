package com.smu.dotbuv10.Medicamentos;
...
import com.smu.dotbuv10.Medicamentos.recordatorio.agendadorA;
...
public class AniadirRecord extends AppCompatActivity implements
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.anadirrecordatorio);
            ...
            switch (item.getItemId()) {
                ...
                case android.R.id.home:
                    ...
                    if (!mVehicleHasChanged) {
                        NavUtils.navigateUpFromSameTask(AniadirRecord.this);
                        return true;
                    }
        ...
        private void deleteReminder() {
            ...
            if (mCurrentReminderUri != null) {
                ...
                if (rowsDeleted == 0) {
                    ...
                    new agendadorA().cancelAlarm(getApplicationContext(),mCurrentReminderUri);
...
*/
            ...
            values.put(ContratosA.AlarmReminderEntry.KEY_TITLE, mTitle);
            values.put(ContratosA.AlarmReminderEntry.KEY_DATE, mDate);
            values.put(ContratosA.AlarmReminderEntry.KEY_TIME, mTime);
            values.put(ContratosA.AlarmReminderEntry.KEY_REPEAT, mRepeat);
            values.put(ContratosA.AlarmReminderEntry.KEY_REPEAT_NO, mRepeatNo);
            values.put(ContratosA.AlarmReminderEntry.KEY_REPEAT_TYPE, mRepeatType);
            values.put(ContratosA.AlarmReminderEntry.KEY_ACTIVE, mActive);
            ...
            if (mCurrentReminderUri == null) {
                ...
                Uri newUri = getContentResolver().insert(ContratosA.AlarmReminderEntry.CONTENT_URI, values);
            ...
            if (mActive.equals("true")) {
                if (mRepeat.equals("true")) {
                    new agendadorA().setRepeatAlarm(getApplicationContext(), selectedTimestamp, mCurrentReminderUri, mRepeatTime);
                } else if (mRepeat.equals("false")) {
                    new agendadorA().setAlarm(getApplicationContext(), selectedTimestamp, mCurrentReminderUri);
                }
        ...
        public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
            ...
            if (cursor.moveToFirst()) {
                int titleColumnIndex = cursor.getColumnIndex(ContratosA.AlarmReminderEntry.KEY_TITLE);
                int dateColumnIndex = cursor.getColumnIndex(ContratosA.AlarmReminderEntry.KEY_DATE);
                int timeColumnIndex = cursor.getColumnIndex(ContratosA.AlarmReminderEntry.KEY_TIME);
                int repeatColumnIndex = cursor.getColumnIndex(ContratosA.AlarmReminderEntry.KEY_REPEAT);
                int repeatNoColumnIndex = cursor.getColumnIndex(ContratosA.AlarmReminderEntry.KEY_REPEAT_NO);
                int repeatTypeColumnIndex = cursor.getColumnIndex(ContratosA.AlarmReminderEntry.KEY_REPEAT_TYPE);
                int activeColumnIndex = cursor.getColumnIndex(ContratosA.AlarmReminderEntry.KEY_ACTIVE);
